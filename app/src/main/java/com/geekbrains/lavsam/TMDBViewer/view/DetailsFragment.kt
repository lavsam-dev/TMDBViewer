...
//    private lateinit var movieDetailBundle: MovieDetail
...
//            populateData(movieDetailData = it)
    ...
    private fun loadMovieDetail(movieDetailData: MovieDetail) {
        try {
            val uri =
                URL("https://api.themoviedb.org/3/movie/${movieDetailData.movie.id}?api_key=$TMDB_API_KEY")
